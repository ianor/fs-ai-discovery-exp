...
async function searchPeople(accessToken, query) {
    ...
    if (query.givenName)
        params.append("givenName", query.givenName);
    if (query.surname)
        params.append("surname", query.surname);
    if (query.gender)
        params.append("gender", query.gender);
    if (query.birthPlace)
        params.append("birthPlace", query.birthPlace);
    if (query.birthYear)
        params.append("birthYear", query.birthYear.toString());
    if (query.deathPlace)
        params.append("deathPlace", query.deathPlace);
    if (query.deathYear)
        params.append("deathYear", query.deathYear.toString());
    try {
